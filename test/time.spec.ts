...
describe('Time', () => {
  describe('#toString()', () => {
    context('With times tring of hours and minutes less than 10', () => {
  ...
  describe('#add()', () => {
    function _before(timestring: string, minutes: number) {
    ...
    context('When added minutes to time do not exceed 60', () => {
      ...
      before(() => {
        timestring = _before(timestring, 1);
      });
    ...
    context('When added minutes exceed 60 and hours are equal to 12 with AM time of day', () => {
      let timestring = '11:55AM';
      before(() => {
        timestring = _before(timestring, 10);
      });
